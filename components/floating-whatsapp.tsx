  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:pr-8 hover:scale-110",
        "group overflow-hidden border border-white/20 backdrop-blur-sm"
      )}
      aria-label="Contactar por WhatsApp"
    >
      {/* Icon with subtle animation */}
      <WhatsAppIcon className="h-7 w-7 flex-shrink-0 group-hover:rotate-12 transition-transform duration-300" />
      ...
      <span className={cn(
        ...
        "transition-all duration-500 ease-out",
        "group-hover:max-w-[200px] group-hover:opacity-100 group-hover:ml-3"
      )}>
        Chatea con nosotros
      </span>
